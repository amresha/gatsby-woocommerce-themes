...
import "./style.scss";
import EduVideo from "../../../images/videos/Education.mp4"
import Home from "../../../images/videos/Home.mp4"
import Bike from "../../../images/videos/Bike.mp4"
import Office from "../../../images/videos/office.mp4"
      	...
      	<source src={Bike} type="video/mp4" />
                   ...
                   <div class="overlay">
                      ...
                      <h2 style={{color: '#00c4f1'}}>Smart Outdoor
                        ...
                        <Link
                          to="/product-category/smart-outdoor/"
      	...
      	<source src={Home} type="video/mp4" />
                   ...
                   <div class="overlay">
                      ...
                      <h2 style={{color: '#1ce000'}}>Smart Home & Garden
                        ...
                        <Link
                          to="/product-category/smart-home-garden/"
                          className="btn btn-light"
                        >SHOP NOW
                        </Link></h2>
                   </div>                   
      	...
      	<source src={Office} type="video/mp4" />
                   ...
                   <div class="overlay">
                      ...
                      <h2 style={{color: '#9c27b0'}}>Smart Office
                        ...
                        <Link
                          to="/product-category/smart-office/"
                          className="btn btn-light"
                        >SHOP NOW
                        </Link></h2>
                   </div>                   
